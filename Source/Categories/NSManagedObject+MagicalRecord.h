...
+ (NSFetchedResultsController *) MR_fetchAllGroupedBy:(NSString *)group withPredicate:(NSPredicate *)searchTerm sortedBy:(NSArray *)sortTerm delegate:(id<NSFetchedResultsControllerDelegate>)delegate;
