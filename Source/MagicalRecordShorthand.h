...
+ (NSFetchRequest *) requestAllSortedBy:(NSArray *)sortTerm;
+ (NSFetchRequest *) requestAllSortedBy:(NSArray *)sortTerm inContext:(NSManagedObjectContext *)context;
+ (NSFetchRequest *) requestAllSortedBy:(NSArray *)sortTerm withPredicate:(NSPredicate *)searchTerm;
+ (NSFetchRequest *) requestAllSortedBy:(NSArray *)sortTerm withPredicate:(NSPredicate *)searchTerm inContext:(NSManagedObjectContext *)context;
+ (NSArray *) findAll;
+ (NSArray *) findAllInContext:(NSManagedObjectContext *)context;
+ (NSArray *) findAllSortedBy:(NSArray *)sortTerm;
+ (NSArray *) findAllSortedBy:(NSArray *)sortTerm inContext:(NSManagedObjectContext *)context;
+ (NSArray *) findAllSortedBy:(NSArray *)sortTerm withPredicate:(NSPredicate *)searchTerm;
+ (NSArray *) findAllSortedBy:(NSArray *)sortTerm withPredicate:(NSPredicate *)searchTerm inContext:(NSManagedObjectContext *)context;
...
+ (id) findFirstWithPredicate:(NSPredicate *)searchterm sortedBy:(NSArray *)property;
+ (id) findFirstWithPredicate:(NSPredicate *)searchterm sortedBy:(NSArray *)property inContext:(NSManagedObjectContext *)context;
...
+ (id) findFirstWithPredicate:(NSPredicate *)searchTerm sortedBy:(NSArray *)sortBy andRetrieveAttributes:(id)attributes, ...;
+ (id) findFirstWithPredicate:(NSPredicate *)searchTerm sortedBy:(NSArray *)sortBy inContext:(NSManagedObjectContext *)context andRetrieveAttributes:(id)attributes, ...;
...
+ (NSArray *) findByAttribute:(NSString *)attribute withValue:(id)searchValue andOrderBy:(NSArray *)sortTerm;
+ (NSArray *) findByAttribute:(NSString *)attribute withValue:(id)searchValue andOrderBy:(NSArray *)sortTerm inContext:(NSManagedObjectContext *)context;
...
+ (NSFetchedResultsController *) fetchAllSortedBy:(NSArray *)sortTerm withPredicate:(NSPredicate *)searchTerm groupBy:(NSString *)groupingKeyPath delegate:(id<NSFetchedResultsControllerDelegate>)delegate;
+ (NSFetchedResultsController *) fetchAllSortedBy:(NSArray *)sortTerm withPredicate:(NSPredicate *)searchTerm groupBy:(NSString *)groupingKeyPath delegate:(id<NSFetchedResultsControllerDelegate>)delegate inContext:(NSManagedObjectContext *)context;
+ (NSFetchedResultsController *) fetchAllGroupedBy:(NSString *)group withPredicate:(NSPredicate *)searchTerm sortedBy:(NSArray *)sortTerm;
+ (NSFetchedResultsController *) fetchAllGroupedBy:(NSString *)group withPredicate:(NSPredicate *)searchTerm sortedBy:(NSArray *)sortTerm inContext:(NSManagedObjectContext *)context;
+ (NSFetchedResultsController *) fetchAllGroupedBy:(NSString *)group withPredicate:(NSPredicate *)searchTerm sortedBy:(NSArray *)sortTerm delegate:(id<NSFetchedResultsControllerDelegate>)delegate;
+ (NSFetchedResultsController *) fetchAllGroupedBy:(NSString *)group withPredicate:(NSPredicate *)searchTerm sortedBy:(NSArray *)sortTerm delegate:(id<NSFetchedResultsControllerDelegate>)delegate inContext:(NSManagedObjectContext *)context;
@end
